  ...
  return (
    <AuthLayout type="login">
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-neutral-content mb-1">Welcome Back</h1>
        <p className="text-sm sm:text-base text-base-content/70 mb-6 sm:mb-8">Sign in to your account</p>
